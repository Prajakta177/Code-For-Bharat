...
import { Wallet, TrendingUp, TrendingDown, PieChart, Sparkles, Plus, Calendar, Target } from 'lucide-react'
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              Dashboard
              <Sparkles className="w-6 h-6 ml-2 text-orange-500 animate-pulse" />
            </h1>
      ...
      {/* Balance and Savings Cards - Only show for current month */}
      {isCurrentMonth && (
                ...
                <div className="text-center">
                  ...
                  {isCurrentMonth && (
                    <>
                      ...
                      <button className="mt-4 bg-gradient-to-r from-blue-600 to-orange-500 text-white px-4 py-2 rounded-lg text-sm hover:from-blue-700 hover:to-orange-600 transition-all flex items-center space-x-2 mx-auto">
      ...
      {isCurrentMonth && (
        <AnimatedCard delay={900} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button
              onClick={() => setShowSavingsHistoryModal(true)}
              className="flex items-center space-x-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-left"
            >
              <Target className="w-5 h-5 text-green-600" />
              <div>
                <p className="font-medium text-green-900">View Savings History</p>
                <p className="text-sm text-green-600">See your savings achievements</p>
              </div>
            </button>
          </div>
        </AnimatedCard>
      ...
      <SavingsHistoryModal 
        isOpen={showSavingsHistoryModal}
        onClose={() => setShowSavingsHistoryModal(false)}
      />
    </div>
  )
}
